...
XIV(bool, showMoveSizeStatus,                   false)
...
XSV(const char *, winMenuItems,                 "rmftic")
...
XIV(bool, taskBarShowApmAuto,                   false)
