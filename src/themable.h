...
XIV(bool, trayDrawBevel,                        true)
XIV(bool, titleBarCentered,                     true)
...
XSV(const char *, titleButtonsRight,            "xmi")
XSV(const char *, titleButtonsSupported,        "xmis");
XSV(const char *, themeAuthor,                  0)
XSV(const char *, themeDescription,             0)

XFV(const char *, titleFontName,                FONT(120), "WenQuanYi Zen Hei:size=12")
XFV(const char *, menuFontName,                 BOLDFONT(100), "WenQuanYi Zen Hei:size=11:bold")
XFV(const char *, statusFontName,               BOLDTTFONT(120), "WenQuanYi Zen Hei:size=12:bold")
XFV(const char *, switchFontName,               BOLDTTFONT(120), "WenQuanYi Zen Hei:size=12:bold")
XFV(const char *, normalButtonFontName,         FONT(120), "WenQuanYi Zen Hei:size=12")
XFV(const char *, activeButtonFontName,         BOLDFONT(120), "WenQuanYi Zen Hei:size=12:bold")
#ifdef CONFIG_TASKBAR
XFV(const char *, normalTaskBarFontName,        FONT(120), "WenQuanYi Zen Hei:size=12")
XFV(const char *, activeTaskBarFontName,        BOLDFONT(120), "WenQuanYi Zen Hei:size=12:bold")
XFV(const char *, toolButtonFontName,           FONT(120), "WenQuanYi Zen Hei:size=12")
XFV(const char *, normalWorkspaceFontName,      FONT(120), "WenQuanYi Zen Hei:size=12")
XFV(const char *, activeWorkspaceFontName,      FONT(120), "WenQuanYi Zen Hei:size=12")
#endif
XFV(const char *, minimizedWindowFontName,      FONT(120), "WenQuanYi Zen Hei:size=12")
XFV(const char *, listBoxFontName,              FONT(120), "WenQuanYi Zen Hei:size=12")
XFV(const char *, labelFontName,                FONT(140), "WenQuanYi Zen Hei:size=12")
